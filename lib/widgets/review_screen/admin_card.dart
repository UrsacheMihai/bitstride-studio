        ...
        child: ExpansionTile(
          ...
          subtitle: Text(
            AppLocalizations.of(context)!
                .byCreator(challenge.creatorName, challenge.difficulty),
            style: TextStyle(
              fontSize: 12,
                ...
                children: [
                  ...
                  if (challenge.hasCpp) ...[
                    ...
                    Container(
                      ...
                      child: Text(challenge.solutionCodeCpp!.trim(),
                  ...
                  if (challenge.hasPython) ...[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: Colors.white.withOpacity(0.06))),
                      child: Text(challenge.solutionCodePython!.trim(),
                          style: const TextStyle(
                              fontFamily: 'monospace',
                              fontSize: 12,
                              color: Colors.white70)),
                  ...
                  const SizedBox(height: 10),
                  Text(
                      AppLocalizations.of(context)!.testCasesFiles(
                          challenge.tests.length, challenge.files.length),
                      style: TextStyle(
                        fontSize: 12,
                        color: isDark ? Colors.grey[500] : Colors.grey[600],
                      )),
                            ...
                            SnackBar(
                              content: Row(
                                children: [
                                  ...
                                  Text(
                                      AppLocalizations.of(context)!.copiedJson),
                                ],
                              ),
