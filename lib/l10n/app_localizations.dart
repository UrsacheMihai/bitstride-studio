...
abstract class AppLocalizations {
  ...
  /// No description provided for @addContentBlock.
  ///
  /// In en, this message translates to:
  /// **'Add Content Block'**
  String get addContentBlock;
  ...
  /// No description provided for @blockCode.
  ///
  /// In en, this message translates to:
  /// **'Code'**
  String get blockCode;

  /// No description provided for @blockImageURL.
  ///
  /// In en, this message translates to:
  /// **'Image URL'**
  String get blockImageURL;

  /// No description provided for @privateCodeHint.
  ///
  /// In en, this message translates to:
  /// **'🔒 This code is private — used ONLY for validation. Users in the Core app will NOT see it.'**
  String get privateCodeHint;

  /// No description provided for @cppSolution.
  ///
  /// In en, this message translates to:
  /// **'C++ Solution'**
  String get cppSolution;

  /// No description provided for @pythonSolution.
  ///
  /// In en, this message translates to:
  /// **'Python Solution'**
  String get pythonSolution;
  ...
  /// No description provided for @highlightGlow.
  ///
  /// In en, this message translates to:
  /// **'Highlight (Glow)'**
  String get highlightGlow;
  ...
  /// No description provided for @optionsSelectCorrect.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @enterOptionText.
  ///
  /// In en, this message translates to:
  /// **'Enter option text...'**
  String get enterOptionText;
